...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c)) var q = "\x3c" + k + "\x3e", n = "\x3c/" + k + "\x3e",
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, x = c.endOffset, z, h = this.guard, p = this.type,
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(),
            l = CKEDITOR.dom.walker.bookmark(), k = CKEDITOR.dom.walker.temp(), n = function (a) {
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, q = this.endContainer, g = this.startOffset,
                        l = this.endOffset, k = 1, z = 1;
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, q = d.block, g = null;
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var p = this, e = [], m = this.editor && this.editor.config.protectedSource, r, g = !1,
        ...
        var Q = {styles: 1, attributes: 1, classes: 1},
            ...
            I = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, E = /^cke:(object|embed|param)$/,
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, l, k) {
                ...
                var B = new CKEDITOR.htmlParser,
                    ...
                    y = [], F = [], t = q, z = "textarea" == q.name, h = "pre" == q.name;
                    ...
                    if (a(m)) y.push(m); else {
                        ...
                        if ("br" == e) F.push(m); else {
                            for (; !(f = (g = t.name) ? CKEDITOR.dtd[g] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, m.isUnknown || t.isUnknown || f[e]);) if (t.isOptionalClose) B.onTagClose(g); else if (e in b && g in b) g = t.children, (g = g[g.length - 1]) && "li" == g.name || x(g = new CKEDITOR.htmlParser.element("li"), t), !m.returnPoint && (m.returnPoint = t), t = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !u(e, g)) B.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !u(e, g)) !m.returnPoint && (m.returnPoint = t), t = t.parent; else if (g in CKEDITOR.dtd.$inline && y.unshift(t), t.parent) x(t, t.parent, 1); else {
                                m.isOrphan = 1;
                                break
                            }
                            n(e);
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    g = Array.prototype.slice.call(arguments, 1), l = this.rules, k = l.length, n, w, f, x;
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, h, c = q(c, b), c = f(c, M), c = w(c), c = f(c, R), c = c.replace(v, "$1cke:$2"),
        ...
        var y = /(?:&nbsp;|\xa0)$/, F = "{cke_protected}", t = CKEDITOR.dtd,
            z = "caption colgroup col thead tfoot tbody".split(" "), h = CKEDITOR.tools.extend({}, t.$blockLimit,
            t.$block), p = {elements: {input: k, textarea: k}},
        ...
        var G = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            D = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, I = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        var f = CKEDITOR.dom.walker.whitespaces(!0), x = CKEDITOR.dom.walker.bookmark(!1, !0),
            A = CKEDITOR.dom.walker.empty(), u = CKEDITOR.dom.walker.bogus(),
                    ...
                    list: {
                        detectMerge: function (a, b) {
                            var d = c(b, a.bookmark),
                                e = d.startPath(), h = d.endPath(), f = e.contains(CKEDITOR.dtd.$list),
                            ...
                            if (a.mergeListBookmark) {
                                var d = a.mergeListBookmark.startNode,
                                    e = a.mergeListBookmark.endNode, f = new CKEDITOR.dom.elementPath(d, c),
                        ...
                        function a(c) {
                            var e = [], h, f = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d),
                                m = c.endPath().contains(d), p = {};
                            f.guard = function (a,
                                                f) {
                                if (a.type == CKEDITOR.NODE_ELEMENT) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, h = CKEDITOR.document, g = e.editable(), p = f.getBody(),
                    k = f.getDocumentElement(), n = g.isInline(), v, D;
    ...
    (function () {
                ...
                for (r.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(w)) r = null, k = !0; else {
                        var t = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
                            x = t && "false" == r.getAttribute("contentEditable"), y = t &&
        ...
        var C = {
                ...
                audio: 1,
                video: 1
            }, G = /\s*(?:;\s*|$)/, H = /#\((.+?)\)/g, K = CKEDITOR.dom.walker.bookmark(0, 1),
